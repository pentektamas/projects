...
public class AdministratorView extends JDialog {
	...
	private JList employeesList = new JList();
	...
	public void addAdminPanel(String name) {
		...
		p1.add(addEmployee);
		p2.add(readEmployees);
		p3.add(updateEmployee);
		p4.add(deleteEmployee);
		p5.add(nameLabel);
		p5.add(logOutButton);
		p6.add(select);
	...
	public void addUpdateEmployeePanel(List<String> values) {
		...
		JLabel passwordLabel = new JLabel("Password: ");
		JLabel phoneLabel = new JLabel("Phone number: ");
		employees = new JComboBox(values.toArray());
	...
	public void addReadEmployeePanel(String text) {
		JTextArea employeeTextArea = new JTextArea(15, 30);
	...
	public void addDeleteEmployeePanel(List<String> names) {
		employeesList = new JList<String>(names.toArray(new String[names.size()]));
	...
	public void updateDeleteEmployeeList(List<String> names) {
		// employeesList = new JList(names.toArray(new String[names.size()]));
	...
	/*
	 * public void logInAnimation() { logInPanel.createLoadingAnimation(); }
	 */
