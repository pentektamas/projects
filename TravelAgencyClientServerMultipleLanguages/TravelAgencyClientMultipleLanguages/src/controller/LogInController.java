...
public class LogInController {
	...
	public LogInController(int type, IAvionDAC stubAvion, IBiletDAC stubBilet, ICalatorDAC stubCalator,
		...
		panel = new LogInPanel(resourceBundle);
		resourceBundle.attach(panel);
		this.type = type;
		addActionListeners();
	}
	...
	private void addActionListeners() {
		...
		panel.addLanguageListener(new LanguageListener());
	}
