...
public class AdministratorView extends JDialog implements Observer {
	...
	private JLabel listOfEmployees;
	private String adminName;

	public AdministratorView(String name, RBundle bundle) {
		this.adminName = name;
		...
		this.operationID = 0;
		addEmployee = new JButton(resourceBundle.getString("addEmployee"));
		readEmployees = new JButton(resourceBundle.getString("readEmployees"));
		updateEmployee = new JButton(resourceBundle.getString("updateEmployee"));
		deleteEmployee = new JButton(resourceBundle.getString("deleteEmployee"));
		...
		select = new JLabel(resourceBundle.getString("selectEmployee"));
		nameLabel = new JLabel(resourceBundle.getString("nameLabel"));
		ageLabel = new JLabel(resourceBundle.getString("ageLabel"));
		...
		phoneLabel = new JLabel(resourceBundle.getString("phoneLabel"));
		listOfEmployees = new JLabel(resourceBundle.getString("listOfEmployees"));
		adminNameLabel = new JLabel(resourceBundle.getString("usersNameLabel", adminName));
		...
		this.setTitle(resourceBundle.getString("adminTitle"));
		this.pack();
	...
	public void update() {
		...
		addEmployee.setText(resourceBundle.getString("addEmployee"));
		readEmployees.setText(resourceBundle.getString("readEmployees"));
		updateEmployee.setText(resourceBundle.getString("updateEmployee"));
		deleteEmployee.setText(resourceBundle.getString("deleteEmployee"));
		...
		select.setText(resourceBundle.getString("selectEmployee"));
		nameLabel.setText(resourceBundle.getString("nameLabel"));
		ageLabel.setText(resourceBundle.getString("ageLabel"));
		userNameLabel.setText(resourceBundle.getString("userNameLabel"));
		passwordLabel.setText(resourceBundle.getString("passwordLabel"));
		phoneLabel.setText(resourceBundle.getString("phoneLabel"));
		listOfEmployees.setText(resourceBundle.getString("listOfEmployees"));
		adminNameLabel.setText(resourceBundle.getString("usersNameLabel", adminName));
		this.setTitle(resourceBundle.getString("adminTitle"));
	}

	public void addAdminPanel() {
		adminNameLabel.setFont(new Font("Arial", Font.ITALIC, 16));
	...
	public int getAgeText() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, resourceBundle.getString("invalidAge"),
					resourceBundle.getString("wrongAge"), JOptionPane.ERROR_MESSAGE);
		}
		return val;
	}
	...
	public void showInvalidInputMessage() {
		JOptionPane.showMessageDialog(null, resourceBundle.getString("InvalidInputMessage"),
				resourceBundle.getString("wrongTextInput"), JOptionPane.WARNING_MESSAGE);
	}

	public void showAddedSuccesfullyMessage() {
		JOptionPane.showMessageDialog(null, resourceBundle.getString("addedSuccesfullyMessage"),
				resourceBundle.getString("employeeAdded"), JOptionPane.INFORMATION_MESSAGE);
	}

	public void showUpdatedSuccesfullyMessage() {
		JOptionPane.showMessageDialog(null, resourceBundle.getString("updatedSuccesfullyMessage"),
				resourceBundle.getString("employeeUpdated"), JOptionPane.INFORMATION_MESSAGE);
	}

	public void showInsertErrorMessage() {
		JOptionPane.showMessageDialog(null, resourceBundle.getString("insertErrorMessage"),
				resourceBundle.getString("duplicateEmployee"), JOptionPane.ERROR_MESSAGE);
	}

	public void showUpdateErrorMessage() {
		JOptionPane.showMessageDialog(null, resourceBundle.getString("updateErrorMessage"),
				resourceBundle.getString("wrongUsername"), JOptionPane.ERROR_MESSAGE);
	}
